...
public class SchermataAvvio {
	...
	/* 
	   Il metodo costruttore riceve la logica del gioco e la classifica, crea la finestra 
	   e richiama il metodo elementiPagina() per costruire l'interfaccia grafica.
	*/
	...
	/* 
	   Il metodo elementiPagina() ha il compito di creare l'interfaccia grafica della pagina di avvio. 
	   In questo metodo vengono creati diversi pannelli che suddividono la pagina in tre zone: 
	   - area titolo (intestazione);
	   - area scelta (inserimento nome, radiobutton, menu a tendina, tasto avvia); 
	   - area bottoni (tasti regole e classifica). 
	*/
