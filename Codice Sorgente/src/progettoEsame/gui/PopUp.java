...
public class PopUp {
	...
	/* Questo pop up viene mostrato quando l'utente non inserisce il nome 
	   nella schermata di avvio gioco. */
	...
	/* Questo pop up viene mostrato quando l'utente inserisce nel sudoku un numero già 
	   presente nella stessa riga,colonna o blocco 3x3 (schermata di gioco). */
	...
	/* Questo pop up mostra la classifica creata partita dopo partita. 
	   La classifica è ordinata in base al tempo di esecuzione del sudoku.
	   Il bottone è disponibile nella schermata di avvio e di gioco. */
	...
	/* Questo pop up viene mostrato quando l'utente vuole uscire dal gioco;  
	   Viene chiesto di confermare prima di uscire (schermata di gioco). */
	...
	/* Questo pop up viene mostrato quando l'utente vuole uscire dal gioco.
	   Viene chiesto se desidera salvare la partita (schermata di gioco). */
